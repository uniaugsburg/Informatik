...
oder das Verhalten eines physikalischen Systems enth\"alt.}\\\\
		...
		\begin{align*}
			...
			\textbf{Normalisierte Frequenz } & f_{norm} = \frac{f}{f_s} \text{(Zeitnormalisiert: Zeiteinheitenlos durch Kürzen)}\\
...
definiert der eine Eingangsfolge mit den Werten der Folge $x[n]$
